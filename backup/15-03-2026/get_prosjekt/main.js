...
/* const random_pos_x = Math.floor(Math.random() * max_width)
const random_pos_y = Math.floor(Math.random() * max_height)
const r_ch = Math.floor(Math.random() * 255) + 1
const g_ch = Math.floor(Math.random() * 255) + 1
const b_ch = Math.floor(Math.random() * 255) + 1
let a_ch = 0
...
const screensaver_set_init = 10000
...
const cube_rotate_interval = 100
let rotate_timer = 0
...
let cube_pos_y_max = max_height - cube_size_y
    ...
    ctx.lineWidth = cube_pos_x / 100 * 0.05
/*     const grad=ctx.createLinearGradient(0, 0, 0, 1);
    ...
    //ctx.strokeStyle = `rgb(100,230,255)`

    let colour_shift
    ctx.strokeStyle = `rgba(
    ${cube_pos_x / 255},
    ${cube_pos_x * 0.255 + 65},
    ${cube_pos_x * 0.255 + 130},
    1)` 
