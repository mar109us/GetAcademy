...
const cube_rotate_interval = 200
let rotate_timer = 0
...
/*     ctx.strokeStyle = `rgba(
    ...
    ${150 + Math.floor(Math.random() * 55)},
    ${Math.floor(Math.random() * 10) * 0.02})`  */

/*     ctx.strokeStyle = `rgba(
    ${60 + Math.floor(Math.random() * 4)},
    ${10 + Math.floor(Math.random() * 75)},
    ${90 + Math.floor(Math.random() * 49)},
    ${Math.floor(Math.random() * 10) * 0.09})`  */
